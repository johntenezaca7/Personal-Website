               ...
               <div className="app-list">
                    <div className="gigem"> 
                        ...
                        <div className="app-text">
                            <h3><a href="https://gig-em.herokuapp.com/">Gig-em</a></h3>
                    ...
                    <div className="brev">
                        ...
                        <div className="app-text">
                            <h3><a href="http://hrbrevity.herokuapp.com/">Brevity</a></h3>
                    ...
                    <div className="your-m">
                        ...
                        <div className="app-text">
                            <h3> <a href="https://pacific-chamber-79583.herokuapp.com/">urMeteorologist</a></h3>
